...
<div id="container">
  <h2>No route matches [GET] &quot;/ie10-viewport-bug-workaround.js&quot;</h2>

  
<p><code>Rails.root: /Users/xfhuang/code/Website/analysis_website</code></p>
...
<tr class='route_row' data-helper='path'>
  <td data-route-name='process_information_comments'>
      process_information_comments<span class='helper'>_path</span>
  </td>
  <td data-route-verb='GET'>
    GET
  </td>
  <td data-route-path='/process_informations/:process_information_id/comments(.:format)' data-regexp='^\/process_informations\/([^\/.?]+)\/comments(?:\.([^\/.?]+))?$'>
    /process_informations/:process_information_id/comments(.:format)
  </td>
...
<tr class='route_row' data-helper='path'>
  <td data-route-name='new_process_information_comment'>
      new_process_information_comment<span class='helper'>_path</span>
  </td>
  <td data-route-verb='GET'>
    GET
  </td>
  <td data-route-path='/process_informations/:process_information_id/comments/new(.:format)' data-regexp='^\/process_informations\/([^\/.?]+)\/comments\/new(?:\.([^\/.?]+))?$'>
    /process_informations/:process_information_id/comments/new(.:format)
  </td>
...
<tr class='route_row' data-helper='path'>
  <td data-route-name='edit_process_information_comment'>
      edit_process_information_comment<span class='helper'>_path</span>
  </td>
  <td data-route-verb='GET'>
    GET
  </td>
  <td data-route-path='/process_informations/:process_information_id/comments/:id/edit(.:format)' data-regexp='^\/process_informations\/([^\/.?]+)\/comments\/([^\/.?]+)\/edit(?:\.([^\/.?]+))?$'>
    /process_informations/:process_information_id/comments/:id/edit(.:format)
  </td>
...
<tr class='route_row' data-helper='path'>
  <td data-route-name='process_information_comment'>
      process_information_comment<span class='helper'>_path</span>
  </td>
  <td data-route-verb='GET'>
    GET
  </td>
  <td data-route-path='/process_informations/:process_information_id/comments/:id(.:format)' data-regexp='^\/process_informations\/([^\/.?]+)\/comments\/([^\/.?]+)(?:\.([^\/.?]+))?$'>
    /process_informations/:process_information_id/comments/:id(.:format)
  </td>
...
<tr class='route_row' data-helper='path'>
  <td data-route-name='process_informations'>
      process_informations<span class='helper'>_path</span>
  </td>
  <td data-route-verb='GET'>
    GET
  </td>
  <td data-route-path='/process_informations(.:format)' data-regexp='^\/process_informations(?:\.([^\/.?]+))?$'>
    /process_informations(.:format)
  </td>
  <td data-route-reqs='process_informations#index'>
    process_informations#index
  </td>
</tr>
<tr class='route_row' data-helper='path'>
  <td data-route-name=''>
  ...
  <td data-route-reqs='process_informations#create'>
    process_informations#create
  </td>
</tr>
<tr class='route_row' data-helper='path'>
  <td data-route-name='new_process_information'>
      new_process_information<span class='helper'>_path</span>
  </td>
  <td data-route-verb='GET'>
    GET
  </td>
  <td data-route-path='/process_informations/new(.:format)' data-regexp='^\/process_informations\/new(?:\.([^\/.?]+))?$'>
    /process_informations/new(.:format)
  </td>
  <td data-route-reqs='process_informations#new'>
    process_informations#new
  </td>
</tr>
<tr class='route_row' data-helper='path'>
  <td data-route-name='edit_process_information'>
      edit_process_information<span class='helper'>_path</span>
  </td>
  <td data-route-verb='GET'>
    GET
  </td>
  <td data-route-path='/process_informations/:id/edit(.:format)' data-regexp='^\/process_informations\/([^\/.?]+)\/edit(?:\.([^\/.?]+))?$'>
    /process_informations/:id/edit(.:format)
  </td>
  <td data-route-reqs='process_informations#edit'>
    process_informations#edit
  </td>
</tr>
<tr class='route_row' data-helper='path'>
  <td data-route-name='process_information'>
      process_information<span class='helper'>_path</span>
  </td>
  <td data-route-verb='GET'>
    GET
  </td>
  <td data-route-path='/process_informations/:id(.:format)' data-regexp='^\/process_informations\/([^\/.?]+)(?:\.([^\/.?]+))?$'>
    /process_informations/:id(.:format)
  </td>
  <td data-route-reqs='process_informations#show'>
    process_informations#show
  </td>
</tr>
<tr class='route_row' data-helper='path'>
  <td data-route-name=''>
  ...
  <td data-route-reqs='process_informations#update'>
    process_informations#update
  </td>
</tr>
<tr class='route_row' data-helper='path'>
  <td data-route-name=''>
...
<tr class='route_row' data-helper='path'>
  ...
  <td data-route-reqs='process_informations#destroy'>
    process_informations#destroy
  </td>
</tr>
<tr class='route_row' data-helper='path'>
  <td data-route-name='process_informations_search'>
      process_informations_search<span class='helper'>_path</span>
  </td>
  <td data-route-verb='POST'>
    POST
  </td>
  <td data-route-path='/process_informations/search(.:format)' data-regexp='^\/process_informations\/search(?:\.([^\/.?]+))?$'>
    /process_informations/search(.:format)
  </td>
  <td data-route-reqs='process_informations#search'>
    process_informations#search
  </td>
</tr>
...
<div class="details">
  ...
  <div id="session_dump" style="display:none"><pre>_csrf_token: &quot;Oqf+1uEZD9T+HVSgS+Jiq/7kmhrKM+vx0/LMWG5arnc=&quot;
session_id: &quot;64ff15fc7a9f94b02528e30c8a167e75&quot;</pre></div>
</div>
...
<div id="console"
  ...
  data-session-id='e615edacf5539124a3546cbc85268c3c'
  data-prompt-label='>> '>
</div>
